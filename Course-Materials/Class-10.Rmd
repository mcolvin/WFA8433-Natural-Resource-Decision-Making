...
Poisson distribution can be fit using the `glm()` function. The syntax 
is similar to the `lm()` function. 
...
I thought. Well, the link function for the Poisson was a log. It has 
...
Let's fit a linear model and see how that goes.
