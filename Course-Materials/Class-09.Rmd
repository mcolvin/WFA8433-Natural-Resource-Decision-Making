...
Ok, nowwe have 2 things that we need, the expectation (i.e., $\mu$) that 
...
critter (e.g., hogs, carp) that destroys habitat. Folks have gone out 
and quantified the amount of habitat area destroyed and related the 
amount destroyed to the density of invasive critters. But we also know 
...
habitat but also with increasing critter density. In netica this 
relationship of habitat area and density on area destroyed looks like 
this. 


<!--
Netica figure influence of density and habitat area
-->
...
$$\text{Area damage}_i \sim Normal(\mu, `r round(sigma,1)`) \text{  (Eq. 9)}$$

The whole thing can be put into Netica where you can propagate the 
uncertainty in the decision making process! More on how to do this will
follow in classes.
