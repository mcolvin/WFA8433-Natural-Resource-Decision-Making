...
* Assignment due: None
* Class project: Thinkg about decision model (objectives, nodes, utilities)
...
Mixed Model (GLMM)
2. Account for hiearchical dependence in linear model
3. Use upper level predictors in a hiearchical linear
model.
...
Here is a list of betas we need to predict our poisson distributated
outcomes.
