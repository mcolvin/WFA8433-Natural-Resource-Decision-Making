...
Having the skills to simulate the process and sampling model will
pay big returns, hopefully, as you can further your understanding of
...
* $\psi = 0.35$
* A sampling frame of 3000 points
* A sample of 

Formally, the occupancy part of the equation is
...
* $Z$ is the site occupancy status
* $i$ indexes each site sampled
...
What happens when $p < 1$? Well we can simulate that too by simply 
...
Because $p$ is less than 1 we can formally express $p$ as
...
Let's explore this for a range of $p$ from 0.1 to 1 to examine that 
...
Let's simulate our detection histories.  
