...
where 
* $\beta_0_{\psi,0}$ is the intercept (`beta_psi_0`),
...
effect, assuming detection probabitiy is homogenous among sites.
...
Now we can fit an occupancy model. Note that in the model equation the 
first tilda is for occupancy and the second is for detection. We can
